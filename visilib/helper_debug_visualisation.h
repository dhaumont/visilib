...
namespace visilib
{
    ...
    */
    ...
    inline HelperDebugVisualisation::HelperDebugVisualisation()
    {
    ...
    inline void HelperDebugVisualisation::addRemovedEdge(const MathVector3f& aBegin, const MathVector3f& anEnd)
    {
    ...
    inline void HelperDebugVisualisation::addStabbingLine(const MathVector3f& aBegin, const MathVector3f& anEnd)
    {
    ...
    inline void HelperDebugVisualisation::addSamplingLine(const MathVector3f& aBegin, const MathVector3f& anEnd)
    {
    ...
    inline void HelperDebugVisualisation::addExtremalStabbingLine(const MathVector3f& aBegin, const MathVector3f& anEnd)
    {
    ...
    inline void  HelperDebugVisualisation::addRemovedTriangle(const MathVector3f& a1, const MathVector3f& a2, const MathVector3f& a3)
    {
    ...
    inline void HelperDebugVisualisation::clear()
    {
        mDebugOutput.close();
        mDebugOutput.open("debug.txt");
