...
namespace visilib
{
    ...
    public:
       ...
       */
        static GeometryPositionType split(const P& aPlane, PluckerPolytopeComplex<P,S>& aComplex, SplitAlgorithmStatus<S>& aStatus)
    };
...
template<class P, class S>
inline void PluckerPolytopeSplitter::split(const P& aPlane, PluckerPolytopeComplex<P,S>& aComplex, SplitAlgorithmStatus<S>& aStatus)
{           
